let pizzaJson = [
    ...
    {id:2, name:'Calabresa', img:'images/pizza2.png', price:18.00, sizes:['320g', '530g', '860g'], description:'essa descricao foi modificada por um arquivo json'},
    ...
    {id:8, name:'balnilha', img:'images/pizza7.png', price:22.36, sizes:['320g', '530g', '860g'], description:'otima para tirar gosto de pinga'}
];